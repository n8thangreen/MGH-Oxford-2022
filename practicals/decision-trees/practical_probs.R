...
# jpeg(file = "cost.recovery.histogram.jpg")  # save
hist(c.rec,
     breaks = 20,
...
# Generate a histogram of probabilities following a
# beta-distribution for illustrative purposes

# jpeg(width = 960,
#      height = 480,
#      file = "probabilities.beta.histogram.jpg")   # save
par(mfrow = c(1, 2))
hist(p.rec[, 1],
     breaks = 20,
...
# Cost of treatment
c.treat <- t(matrix(rep(c(0, 300, 30), n.samples),
                    ncol = n.samples, nrow = 3))
