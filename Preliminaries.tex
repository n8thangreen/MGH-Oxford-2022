...
\begin{itemize}
\item 0:00-1:00 Health Economics modelling lecture
\item 1:00 - 1:45 Decision tree and Markov model practical
\item BREAK
\item 1:50 - 2:20 Sensitivity analysis
\item 2:20-3:00 Sensitivity analysis practical
\end{itemize}
}
