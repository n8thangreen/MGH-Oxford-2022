...
\frame{
\frametitle{4.\ Uncertainty analysis \hspace{0pt plus 1 filll} \small $\left[p(\bm\theta\mid e,c)\right.$ vs $\left. g_i(\theta_i)\right]$}
\begin{overprint}
%%%\vspace{7pt}
\onslide<1|handout:0>
...
\begin{center}\includegraphics[scale=.37]{R/marginal-distns}\end{center}
\end{minipage}
&
...
\begin{minipage}[l]{2.5cm}
\begin{tikzpicture}
\draw(0,5) node{\includegraphics[scale=.35]{1.introduction-to-health-economic-evaluations/figs/pi0_grid}};
%\draw(0,5) node{\includegraphics[scale=.27]{1.introduction-to-health-economic-evaluations/figs/pi0}};
\draw(0,3) node{\includegraphics[scale=.27]{1.introduction-to-health-economic-evaluations/figs/rho}};
\draw(0,1) node{\includegraphics[scale=.27]{1.introduction-to-health-economic-evaluations/figs/gamma}};
\draw(0,-1) node{\includegraphics[scale=.27]{1.introduction-to-health-economic-evaluations/figs/chosp}};
