...
# one-way max-min gamma

png(filename = "max-min-gamma.png", width = 150, height = 480)
...
plot(seq(0,1,.01),dbeta(seq(0,1,.01),5,7),axes=F,t="l",lwd=2,xlab="",ylab="")
axis(1)
points(5/(5+7) + 0.2, par()$usr[3],pch=19,col="blue",cex=1.5,lwd=3,xpd=T)
points(5/(5+7) - 0.2, par()$usr[3],pch=19,col="blue",cex=1.5,lwd=3,xpd=T)
text(0.8, 1, labels = bquote(gamma), cex=2.5)
...
# one-way max-min cost

png(filename = "max-min-cost.png", width = 150, height = 480)
...
plot(seq(0,10000,100),dnorm(seq(0,10000,100),6000,1000),axes=F,t="l",lwd=2,xlab="",ylab="")
axis(1)
points(6000 + 2000, par()$usr[3],pch=19,col="blue",cex=1.5,lwd=3,xpd=T)
points(6000 - 2000, par()$usr[3],pch=19,col="blue",cex=1.5,lwd=3,xpd=T)
text(2000, 0.0001, labels = bquote(c^hospital), cex=2.5)
...
png(filename = "psa-1.png", width = 150, height = 480)
...
plot(seq(0,10000,100),dnorm(seq(0,10000,100),6000,1000),axes=F,t="l",lwd=2,xlab="",ylab="")
axis(1)
points(rnorm(1,6000,1000), par()$usr[3],pch=19,col="red",cex=1.5,lwd=3,xpd=T)
text(2000, 0.0001, labels = bquote(c^hospital), cex=2.5)
...
png(filename = "psa-2.png", width = 150, height = 480)
...
png(filename = "psa-3.png", width = 150, height = 480)
